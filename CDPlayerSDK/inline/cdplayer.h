...
#define LP1A5(offs, rt, name, t1, v1, r1, bt, bn) \
   LP1(offs, rt, name, t1, v1, a5, bt, bn, IF_CACHEFLUSHALL, NULL, 0, IF_CACHEFLUSHALL, NULL, 0)
#endif
#ifndef LP2A5
#define LP2A5(offs, rt, name, t1, v1, r1, t2, v2, r2, bt, bn) \
   LP2(offs, rt, name, t1, v1, r1, t2, v2, a5, bt, bn, IF_CACHEFLUSHALL, NULL, 0, IF_CACHEFLUSHALL, NULL, 0)
#endif
#ifndef LP3A5
#define LP3A5(offs, rt, name, t1, v1, r1, t2, v2, r2, t3, v3, r3, bt, bn) \
   LP3(offs, rt, name, t1, v1, r1, t2, v2, r2, t3, v3, a5, bt, bn, IF_CACHEFLUSHALL, NULL, 0, IF_CACHEFLUSHALL, NULL, 0)
#endif
#endif

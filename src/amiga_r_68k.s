; 680x0 optimised Quake render routines by John Selck.
	...
	; r_alias.c:
		...
		XDEF	_R_AliasTransformAndProjectFinalV
		XDEF	@R_AliasTransformAndProjectFinalV
	...
	; r_surf.c:
		...
		XDEF	@R_AddDynamicLights
		XDEF	@R_DrawSurfaceBlock8_mip0
		XDEF	@R_DrawSurfaceBlock8_mip1
		XDEF	@R_DrawSurfaceBlock8_mip2
		XDEF	@R_DrawSurfaceBlock8_mip3
		XDEF	@R_DrawSurfaceBlock16
...
; void __asm R_AliasTransformAndProjectFinalVerts (register __a0 finalvert_t *fv, register __a1 stvert_t *pstverts)

;	point transformation of entities

_R_AliasTransformAndProjectFinalV:
@R_AliasTransformAndProjectFinalV:
		sub.w	#$4c,sp
		fmovem.x	fp2-fp7,-(sp)
...
; void __asm R_ClipEdge (register __a0 mvertex_t *pv0, register __a1 mvertex_t *pv1, register __a2 clipplane_t *clip);
...
; void __asm R_EmitEdge (register __a0 mvertex_t *pv0, register __a1 mvertex_t *pv1)
...
; void __asm TransformVector (register __a0 vec3_t in, register __a1 vec3_t out);
...
; void __asm R_AddDynamicLights (void)

;	adds dynamic lights to lightmaps
...
@R_AddDynamicLights:
		...
		move.l	_r_drawsurf_surf,a6	; surf
...
.adll
		...
		move.l	12(a6),a0	; surf->plane->normal
		fmove.s	(a0)+,fp0
		fmul.s	(a2),fp0
		fmove.s	(a0)+,fp1
		fmul.s	4(a2),fp1
		...
		fneg.x	fp1
.dd
		fmove.s	12(a2),fp2	; rad
		fsub.x	fp1,fp2

		fmove.s	$18(a2),fp3	; minlight
...
; void __asm R_DrawSurfaceBlock8_mip0 (void)
...
; void __asm R_DrawSurfaceBlock8_mip1 (void)
...
; void __asm R_DrawSurfaceBlock8_mip2 (void)
...
; void __asm R_DrawSurfaceBlock8_mip3 (void)
...
@R_DrawSurfaceBlock16:	; not needed in quake 1
		rts
